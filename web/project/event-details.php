...
<?php
    ...
    foreach ($rows as $row)
    {
        ...
        foreach ($injuries as $injury)
        {
            ...
            $sql = "select medical_classification_label from medical_classifications right join injuries on medical_classifications.medical_classification_id = injuries.medical_classification_id WHERE injuries.injury_id=".$injury['injury_id'];
            $stmt = $db->prepare($sql);
